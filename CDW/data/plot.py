...
ID='C:/Users/giaco/Desktop/Cluster/CDW/data/Ramp_V/L_24/Quench_ramp_V'+str(Nmax)+'L_'+str(L)+'Omega_'+str(Omega)+'J_'+str(J)+'V_'+str(V)+'g_'+str(g)+'dt_'+str(dt)+'chi_max_'+str(chi)
"""
