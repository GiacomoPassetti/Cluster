...
import numpy as np
from Wild_debug import ansatz_wf, Suz_trot_im, H_Peier_bond, ansatz_left, Energy, Suz_trot_im_second, Suz_trot_im_try
...
"Parameters of imaginary time ev"
...
H_bond=[]
for i in range(L-1):
   H_bond.append(H_Peier_bond(psi, g, J, Omega,V, (i+1)*h,(i+2)*h, L))
