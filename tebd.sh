...
#SBATCH --job-name=tebd  # The job name.
...
cd $HOME/Spinless_Boson/PBC_tebd
...
python3 main_PBC.py $epsilon $J $hmax


echo \$?

date
" >$HOME/Spinless_Boson/Quench_stark/Bash/addBash_STARKtebd

sbatch <$HOME/Spinless_Boson/Quench_stark/Bash/addBash_STARKtebd
